...
public class AuthenticationFilter implements Filter {
    ...
    private void executeFilterLogic(ServletRequest request, ServletResponse response, FilterChain chain)
        ...
        // Debug: confirm the filter is running
        System.out.println("AuthenticationFilter executed for request: " + httpRequest.getRequestURI());
        ...
        // Debug: print cookies received by the request
        ...
        System.out.println("Token extracted from cookies: " + token);
